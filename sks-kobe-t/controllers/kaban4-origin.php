...
<?php
    ...
    if (isset($_POST["kaban_kojin"])) {
        ...
        $work->inp_t_wk_kaban_time = $_POST["kaban_time"]; // 下番時間
        // $work->inp_t_wk_detail_no = $_POST[""]; // 昼残時間
        // $work->inp_t_wk_detail_no = $_POST[""]; // 休憩残業時間
        // $work->inp_t_wk_detail_no = $_POST[""]; // 深夜残業時間
