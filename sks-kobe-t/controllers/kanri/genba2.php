...
<?php
    ...
    if ($act == "") {
        if (isset($_REQUEST["no"])) {
            ...
            $genba->getGenba();
            if ($common->uae == 1) {
                $genba->oup_m_genba_deleteday[0] = str_replace(array('-', 'ー', '−', '―', '‐'), '', $genba->oup_m_genba_deleteday[0]);
            }
            if ($genba->oup_m_genba_deleteday[0] < 1) {
                $genba->oup_m_genba_deleteday[0] = "";
            }
        }
    }
    ...
    if ($act == "1") {
        ...
        if ($genba2->errmsg == "") {
            ...
            if ($genba_id2 == "") {
                ...
                $genba2->inp_m_genba_deleteday         = $deleteday;
            ...
            $genba->oup_m_genba_deleteday[0]         = $deleteday;
        }
