...
<?php
    ...
    if ($act == "2") {
        ...
        header("Content-Disposition: attachment; filename=kyuyo".$nengetu.".txt");
    }
...
//                            $kyuyo[$taiin_id]["k8"] = $kyuyo[$taiin_id]["k8"] + ($rodo_time[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk]+$zan[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]);
                            $kyuyo[$taiin_id]["k8"] = $kyuyo[$taiin_id]["k8"] + $kintime[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]];
                            $kyuyo[$taiin_id]["h8"] = $jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk];
                            ...
                            // 時間外
                            if (($kyuyo[$taiin_id]["h9"] == "") || ($kyuyo[$taiin_id]["h9"] == ceil(($jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk])*1.25))) {
                                $kyuyo[$taiin_id]["k9"] = $kyuyo[$taiin_id]["k9"] + $zan[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]];
                                $kyuyo[$taiin_id]["h9"] = ceil(($jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk])*1.25);
                                ...
                                $kyuyo[$taiin_id]["h10"] = ceil(($jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk])*0.25);
                            ...
                            $kyuyo[$taiin_id]["h11"] = ceil(($jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk])*1.5);
...
//                                    if (($kyuyo[$taiin_id]["h9"] == "") || ($kyuyo[$taiin_id]["h9"] == ceil(($jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk])*1.25))) {
//                                        $kyuyo[$taiin_id]["k9"] = $kyuyo[$taiin_id]["k9"] + $rodo_time[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk];
//                                        // 今日の所定分が割り増し
//                                        $kyuyo[$taiin_id]["h9"] = ceil(($jikyu[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk])*1.25);
//                                        $kyuyo[$taiin_id]["s9"] = ceil($kyuyo[$taiin_id]["k9"]*$kyuyo[$taiin_id]["h9"]);
//
//                                        $wk_renzan = $rodo_time[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk];
//                                        $wk_zan = $wk_zan + $rodo_time[$taiin_id][$wk->oup_t_wk_genba_id[$i]][$kbn2[$taiin_id][$nengetuwk][$wk->oup_t_wk_genba_id[$i]]][$nengetuwk];
//
//                                    } else {
...
*/
            ob_end_clean();
            $csv  = "\"社員コード\",\"勤怠・昼夜勤①\",\"勤怠・昼夜勤②\",\"勤怠・夜勤①\",\"勤怠・夜勤②\",\"勤怠・日勤①\",\"勤怠・日勤②\",\"勤怠・日勤③\",\"勤怠・時間給\",";
            ...
            $csv .= "\"支給・深夜\",\"支給・ポスト手当\",\"支給・通勤費\",\"控除・弁当代\"";
            $csv .= "\r\n";
...
if ($value["s14"]=="") { $value["s14"]=0; }
            ...
            $csv .= "\"".$key."\",\"".$value["k1"]."\",\"".$value["k2"]."\",\"".$value["k3"]."\",\"".$value["k4"]."\",\"".$value["k5"]."\",\"".$value["k6"]."\",";
            ...
            $csv .= "\"".$value["s12"]."\",\"".$value["s13"]."\",\"".$value["s14"]."\"";
            $csv .= "\r\n";
...
//            echo mb_convert_encoding($csv,"SJIS-win", "UTF-8,EUC-JP,SJIS");
            exit;
