...
<?php
  ...
  $wk_start_time1                 = array("08","00");
  $wk_end_time1                   = array("17","00");
  $wk_start_time2                 = array(null,null);
  $wk_end_time2                   = array(null,null);
  ...
  if ($no) {
    ...
    if ($report3->oup_no) {
      foreach (ReportTable::$report9 as $k => $key) {
...
<?php
    ...
    if ($common->judgephone) {
        // HTML表示
        require_once('../../views/kanri/report9_html.php');
    // キャリア判定（フィーチャーフォン）
    } else {
        // HTML表示
        require_once('../../views/kanri/m/report9_html.php');
    }
?>