...
<?php
    ...
    if ($tuti_sday1 != "" && $tuti_eday1 != "") {
        if ($today >= $tuti_sday1 && $today <= $tuti_eday1) {
            $hyoji = "表示中";
            $_SESSION["hyoji"] = 1;
        } else {
            $hyoji = "非表示";
              ...
              if (count($tuti->oup_m_tuti_no) < 3) {
                for ($i=0;$i<3;$i++) { ?>
                    <tr align="center">
                      <td><?php print($i+1); ?></td>
                      <td>
                        <input type="date" name="tuti_sday[<?php echo $i; ?>]" size="9" maxlength="8" value="<?php 
                        if ($tuti->oup_m_tuti_startday[$i] != "0000-00-00") {
                            if ($uae == 2) { print($tuti->oup_m_tuti_startday[$i]); }
                            else { print(str_replace(array('-', 'ー', '−', '―', '‐'), '', $tuti->oup_m_tuti_startday[$i])); } 
                        } ?>" >
                      </td>
                      <td>
                        <input type="date" name="tuti_eday[<?php echo $i; ?>]" size="9" maxlength="8" value="<?php 
                        if ($tuti->oup_m_tuti_endday[$i] != "0000-00-00") {
                            if ($uae == 2) { print($tuti->oup_m_tuti_endday[$i]); }
                            else { print(str_replace(array('-', 'ー', '−', '―', '‐'), '', $tuti->oup_m_tuti_endday[$i])); } 
                        } ?>" >
                      </td>
