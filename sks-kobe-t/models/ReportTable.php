<?php 
    ...
    class ReportTable
    {
        ...
        public static $report6 = array(
            "no","table","start_date","end_date","joban_time","kaban_time","weather1","weather2","staff_id","wk_start_time1","wk_end_time1","wk_start_time2","wk_end_time2","wk_start_time3","wk_end_time3","patrol_time1","patrol_time2",
            "patrol_time3","patrol_time4","patrol_time5","patrol_time6","patrol_time7","patrol_time8","patrol_time9","patrol_time10","patrol_time11","patrol_time12","patrol_time13","patrol_time14","patrol_time15","patrol_time16","offwk_count","offwk_staff_id1","offwk_staff_id2","off_start_time","off_end_time","outsider","wk_staff_id1","wk_staff_id2","wk_staff_id3","wk_staff_id4","wk_staff_id5","wk_staff_id6","wk_staff_id7","wk_staff_id8","wk_staff_id9","comment",
        );
