        ...
        public function getWk() {
            ...
            $sql = "SELECT "
                 ...
                 if ($this->inp_join_m_staff != "") {
                     $sql .= "join m_staff on t_wk.t_wk_taiin_id = m_staff.m_staff_id ";
                 }
                 if ($this->inp_join_m_genba != "") {
                     $sql .= "join m_genba on t_wk.t_wk_genba_id = m_genba.m_genba_id ";
                 }
                 $sql .= "WHERE 0 = 0 ";
            ...
            if ($this->inp_m_company_id != "") {
                $sql .= "AND m_staff.m_staff_company = '" . $db->escape_string($this->inp_m_company_id) . "' ";
            }
...
//exit;
        ...
        // デリート
        public function deleteWkService() {
            ...
            $sql = "DELETE FROM t_wk_service "
                 . "WHERE 0 = 0 ";
            $sql .= "AND t_wk_service_no = " . $db->escape_string($this->inp_t_wk_no) . " ";
...
// var_dump($sql);
        ...
        public function deleteServiceItem() {
            ...
            $sql = "DELETE FROM m_service_item "
                 . "WHERE 0 = 0 ";
            $sql .= "AND m_service_item_type_cd = " . $db->escape_string($this->inp_m_service_item_type_cd) . " ";
            $sql .= "AND m_service_item_cd = " . $db->escape_string($this->inp_m_service_item_cd) . " ";
