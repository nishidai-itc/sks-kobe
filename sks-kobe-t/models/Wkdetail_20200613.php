        ...
        if ($this->inp_kaban_time != "") {
                ...
                if ($calc_plan_kbn == 1 || $calc_plan_kbn == 2 || $calc_plan_kbn == 3) {
                    if ($wk00_r!=0) {
                            if (($calc_plan_joban_time == $calc_joban_time && $calc_plan_kaban_time == $calc_kaban_time) || $calc_kaban_time == "" || $calc_joban_time == "" || ($calc_joban_time == "" && $calc_kaban_time == "")) {
                                ...
                                $hayazan__time = 0;
                                $tuzan_time = 0;
                                //$kin_time = sprintf('%02d',($wk00/60)).":".sprintf('%02d',($wk00%60));
                                //print($kin_time);
                                //$kj=$kj+$wk00;
                                //$kin_time = sprintf('%02d',($wk00/60)).":".sprintf('%02d',($wk00%60));
                            } else {
                            ...
                            ($calc_plan_kbn == 1 && $calc_plan_kaban_time > $calc_kaban_time)) {
                            $kin_flg = 4;
                            if ($calc_joban_time > $calc_kaban_time) {
                                ...
                                //$syotei = "480";
                                    ...
                                    if ($joban_time > $kaban_time) {
                                        ...
                                        if ($plus != 0) {
                                            $kinmu_time = $plus - $kinmu_time;
                                        }
                                        if ($kinmu_time < $syotei) {
                                            $calc_kinmu_time = $kinmu_time;
                                            $kinmu_time = sprintf('%02d',($kinmu_time/60)).":".sprintf('%02d',($kinmu_time%60));
                                            //print(sprintf('%02d',($kin_time/60)).":".sprintf('%02d',($kin_time%60)));
                                            //$kjikyu=$kjikyu+$kin_time;
                                        } else {
                                            //計算用
                                            $calc_kinmu_time = $kinmu_time;
                                            //DB登録用
                                            $kinmu_time = sprintf('%02d',($syotei/60)).":".sprintf('%02d',($syotei%60));
                                            //print(sprintf('%02d',($syotei/60)).":".sprintf('%02d',($syotei%60)));
                                            //$kjikyu=$kjikyu+$syotei;
                                        }
                                    }
                                ...
                                if ($calc_joban_time != "" && $calc_plan_joban_time != $calc_joban_time && $calc_kaban_time != "") {
                                    if ($calc_plan_joban_time > $calc_joban_time) {
                                        ...
                                        //$plan_joban_time = sprintf('%02d',($wkdetail->oup_t_wk_plan_joban_time[$i]))*60 + substr($wkdetail->oup_t_wk_plan_joban_time[$i],3,2);
                                        //$joban_time = sprintf('%02d',($wkdetail->oup_t_wk_joban_time[$i]))*60 + substr($wkdetail->oup_t_wk_joban_time[$i],3,2);
                                        //$jo_zan = $plan_joban_time - $joban_time;
                                    }
                                }
                                //遅刻-
                                ...
                                if ($calc_kaban_time != "" && $calc_plan_kaban_time != $calc_kaban_time && $calc_joban_time != "") {
                                    if ($calc_plan_kaban_time < $calc_kaban_time) {
                                        ...
                                        //$plan_kaban_time = sprintf('%02d',($wkdetail->oup_t_wk_plan_kaban_time[$i]))*60 + substr($wkdetail->oup_t_wk_plan_kaban_time[$i],3,2);
                                        //$kaban_time = sprintf('%02d',($wkdetail->oup_t_wk_kaban_time[$i]))*60 + substr($wkdetail->oup_t_wk_kaban_time[$i],3,2);
                                        //$ka_zan = $kaban_time - $plan_kaban_time;
                                    }
                                }
                                //早退-
                                ...
                                //日をまたいだ勤務の場合(日勤)
                                if (($calc_plan_kbn == 2 && $calc_plan_joban_time > $calc_kaban_time) || ($calc_plan_joban_time > $calc_kaban_time && $calc_plan_kbn == 3 && $calc_plan_joban_time < $calc_plan_kaban_time)) {
                                    if ($calc_plan_joban_time > $calc_kaban_time) {
                                        if ($calc_plan_joban_time > $calc_joban_time && $calc_plan_kaban_time > $calc_kaban_time ||
                                        $calc_plan_joban_time == $calc_joban_time && $calc_plan_kaban_time > $calc_kaban_time) {
                                            $syotei_otime = $wk00_o;
                                            //計算用
                                            $calc_kinmu_time = $kinmu_time;
                                            //DB登録用
                                            ...
                                            //$kj=$kj+$wk00;
                                            //$kin_flg = 1;
                                        } elseif ($calc_plan_joban_time < $calc_joban_time && $calc_plan_kaban_time > $calc_kaban_time) {
                                            if ($wk00_o != 0) {
                                                //時給に変更
                                                $syotei_otime = 0;
                                                //$sy_zan_del = 1;
                                ...
                                elseif ($wk00_t < $kinmu_time) {
                                ...
                                } elseif ($wk00_o == 0 && $wk00_r < $kinmu_time && ($wk00_r + $wk00_k) > $kinmu_time) {
                                    //計算用
                                    $calc_kinmu_time = $kinmu_time;
                                    //DB登録用
                                    $kinmu_time = sprintf('%02d',($syotei/60)).":".sprintf('%02d',($syotei%60));
                                    ...
                                    //$kjikyu=$kjikyu+$syotei;
                                    //$kin_flg = 3;
                                } elseif ($wk00_o != 0 && $wk00_r < $kinmu_time && $wk00_t > $kinmu_time) {
                                    $syotei_otime = 0;
                                    //$sy_zan_del = 1;
                                    //計算用
                                    $calc_kinmu_time = $kinmu_time;
            ...
            if ($kin_flg == 4) {
                if ($calc_joban_time != "" && $calc_kaban_time != "" && $calc_kinmu_time > $syotei) {
                      ...
                      //$tzan0 = $kin_time - $syotei;
                      //print("<br>&nbsp;");
                      //print(sprintf('%02d',($tzan0/60)).":".sprintf('%02d',($tzan0%60)));
                      //$tzan = $tzan + $tzan0;
                } else {
                      $hayazan_time = 0;
                      $tuzan_time = 0;
                    ...
                    //日をまたいだ勤務の場合(日勤)
                    if (($calc_plan_joban_time > $calc_kaban_time && $calc_plan_kbn == 2) || ($calc_plan_joban_time > $calc_kaban_time && $calc_plan_kbn == 3 && $calc_plan_joban_time < $calc_plan_kaban_time)) {
                        if ($calc_plan_joban_time < $calc_joban_time && $calc_plan_kaban_time > $calc_kaban_time) {
                            $tuzan_time = $calc_kinmu_time - $syotei + 1440;
                            $hayazan_time = 0;
                            $tuzan_time = sprintf('%02d',($tuzan_time/60)).":".sprintf('%02d',($tuzan_time%60));
                            //$tzan0 = $kin_time - $syotei + 1440;
                            //print("&nbsp;<br>");
                            //print(sprintf('%02d',($tzan0/60)).":".sprintf('%02d',($tzan0%60)));
                            //$tzan = $tzan + $tzan0;
                        } else {
                            $tuzan_time = $calc_kinmu_time - $wk00_t + 1440;
                            $hayazan_time = 0;
                            $tuzan_time = sprintf('%02d',($tuzan_time/60)).":".sprintf('%02d',($tuzan_time%60));
                            //$tzan0 = $kin_time - $wk00_t + 1440;
                            //print("&nbsp;<br>");
                            //print(sprintf('%02d',($tzan0/60)).":".sprintf('%02d',($tzan0%60)));
                            //$tzan = $tzan + $tzan0;
                        }
                    }
                    elseif ($calc_plan_kaban_time == $calc_kaban_time && $calc_plan_joban_time > $calc_joban_time) {
                        $hayazan_time = $calc_kinmu_time - $wk00_t;
                        $hayazan_time = sprintf('%02d',($hayazan_time/60)).":".sprintf('%02d',($hayazan_time%60));
                        $tuzan_time = 0;
                        //$szan0 = $kin_time - $wk00_t;
                        //print(sprintf('%02d',($szan0/60)).":".sprintf('%02d',($szan0%60)));
                        //print("<br>&nbsp;");
                        //$szan = $szan + $szan0;
                    } else if ($calc_plan_kaban_time < $calc_kaban_time && $calc_plan_joban_time == $calc_joban_time) {
                        $tuzan_time = $calc_kinmu_time - $wk00_t;
                        $hayazan_time = 0;
                        $tuzan_time = sprintf('%02d',($tuzan_time/60)).":".sprintf('%02d',($tuzan_time%60));
                        //$tzan0 = $kin_time - $wk00_t;
                        //print("&nbsp;<br>");
                        //print(sprintf('%02d',($tzan0/60)).":".sprintf('%02d',($tzan0%60)));
                        //$tzan = $tzan + $tzan0;
                    } else if ($calc_plan_kaban_time < $calc_kaban_time && $calc_plan_joban_time > $calc_joban_time) {
                        ...
                        $hayazan_time = sprintf('%02d',($hayazan_time/60)).":".sprintf('%02d',($hayazan_time%60));
                        $kaban_time1 = sprintf('%02d',($calc_plan_kaban_time))*60 + substr($calc_plan_kaban_time,3,2);
                        $kaban_time2 = sprintf('%02d',($calc_kaban_time))*60 + substr($calc_kaban_time,3,2);
                        $tuzan_time = $kaban_time2 - $kaban_time1;
                        $tuzan_time = sprintf('%02d',($tuzan_time/60)).":".sprintf('%02d',($tuzan_time%60));
                        //$joban_time1 = sprintf('%02d',($wkdetail->oup_t_wk_plan_joban_time[$i]))*60 + substr($wkdetail->oup_t_wk_plan_joban_time[$i],3,2);
                        //$joban_time2 = sprintf('%02d',($wkdetail->oup_t_wk_joban_time[$i]))*60 + substr($wkdetail->oup_t_wk_joban_time[$i],3,2);
                        //$szan0 = $joban_time1 - $joban_time2;
                        //print(sprintf('%02d',($szan0/60)).":".sprintf('%02d',($szan0%60)));
                        //$szan = $szan + $szan0;
                        //print("<br>");
                        //$kaban_time1 = sprintf('%02d',($wkdetail->oup_t_wk_plan_kaban_time[$i]))*60 + substr($wkdetail->oup_t_wk_plan_kaban_time[$i],3,2);
                        //$kaban_time2 = sprintf('%02d',($wkdetail->oup_t_wk_kaban_time[$i]))*60 + substr($wkdetail->oup_t_wk_kaban_time[$i],3,2);
                        //$tzan0 = $kaban_time2 - $kaban_time1;
                        //print(sprintf('%02d',($tzan0/60)).":".sprintf('%02d',($tzan0%60)));
                        //$tzan = $tzan + $tzan0;
                    } else {
                        $tuzan_time = $calc_kinmu_time - $syotei;
