    ...
    class Wkdetail
    {
        ...
        public function getWkdetail()
        {
            ...
            if ($this->inp_t_wk_joban_kbn2 != "") {
                $sql .= "AND t_wk_joban_kbn != '" . $db->escape_string($this->inp_t_wk_joban_kbn2) . "' ";
            }
            if ($this->inp_t_wk_joban_kbn3 != "") {
                $sql .= "AND t_wk_joban_kbn != '" . $db->escape_string($this->inp_t_wk_joban_kbn3) . "' ";
            }
            ...
            if ($this->inp_t_wk_gchk_kbn != "") {
                if ($this->inp_t_wk_gchk_kbn == "0") {
                    $sql .= "AND t_wk_gchk_kbn is null ";
                } else {
                    $sql .= "AND t_wk_gchk_kbn = '" . $db->escape_string($this->inp_t_wk_gchk_kbn) . "' ";
                }
            }
            if ($this->inp_t_wk_schk_kbn != "") {
                if ($this->inp_t_wk_schk_kbn == "0") {
                    $sql .= "AND t_wk_schk_kbn is null ";
                } else {
                    $sql .= "AND t_wk_schk_kbn = '" . $db->escape_string($this->inp_t_wk_schk_kbn) . "' ";
                }
            }
