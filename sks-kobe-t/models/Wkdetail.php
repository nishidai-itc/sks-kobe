...
set_time_limit(300);
    ...
    class Wkdetail
    {
        ...
        public $inp_t_wk_created_staffid;
        ...
        public $inp_t_wk_kaban_kbn_not_in;
        ...
        public function getWkdetail()
        {
            ...
            if ($this->inp_t_wk_plan_kbn_in != "") {
                if ($whereflg == true) { $sql .= "AND "; }
                $sql .= "t_wk_plan_kbn in (".$this->inp_t_wk_plan_kbn_in.") ";
                $whereflg = true;
            }
            ...
            //    $whereflg = true;
            //}
            if ($this->inp_t_wk_jokaban_kbn != "") {
                if ($whereflg == true) { $sql .= "AND "; }
                $sql .= "(t_wk_joban_kbn != '' or t_wk_joban_kbn is not null) AND (t_wk_kaban_kbn != '' or t_wk_kaban_kbn is not null) ";
                $whereflg = true;
            }
            ...
            if ($this->inp_t_wk_kaban_kbn_not_in != "") {
                if ($whereflg == true) { $sql .= "AND "; }
                $sql .= "(t_wk_kaban_kbn not in (" . $db->escape_string($this->inp_t_wk_kaban_kbn_not_in) . ") or t_wk_kaban_kbn is null) ";
                $whereflg = true;
            }
...
// require dirname(__FILE__).'/common/insertlog.php';
        ...
        public function updateWkdetail()
        {
            ...
            if ($this->inp_t_wk_created_id != "") {
                if ($whereflg == true) {
                    $sql .= ",";
                }
                $sql .= "    t_wk_created_id          = '" . $this->inp_t_wk_created_id . "' ";
                $whereflg = true;
            }
