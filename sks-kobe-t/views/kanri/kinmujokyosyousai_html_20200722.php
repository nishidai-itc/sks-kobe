...
-->
          ...
          <table class="table table-sm table-bordered">
            ...
            <!-- 手入力 -->
            <tr>
              <td class="table-warning text-right" rowspan="4" width=250>手入力　　　　　<input type="checkbox" name="inp_kbn" id="inp_kbn" value="1" <?php if ($wkdetail->oup_t_wk_inp_kbn[0]=="1") { print("checked"); } ?> ></td>
                ...
                <div class="input-form-size">
                  <div class="input-group input-group-sm">
                    <input type="number" name="kinmu_time[0]" class="inp form-control input-form-right text-center"
                      value="<?php print($kinmu_time[0]); ?>" min="0" max="23" id="kinmuTimeHours">
                    <div class="input-group-prepend input-group-colon">
                      <span class="input-group-text">:</span>
                    </div>
      ...
      <div class="row">
        <div class="col-6">
          <button type="submit" class="btn btn-success btn-block" name="update" value="1">更新</button>
        </div>
        <div class="col-6">
