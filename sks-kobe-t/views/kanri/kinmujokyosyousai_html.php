                  ...
                  <div class="input-form-size">
                    <div class="input-group input-group-sm">
                      <input type="number" name="plan_joban_time[0]" class="form-control input-form-right text-center"
                        value="<?php print($plan_joban_time[0]); ?>" min="0" max="23" id="planJobanTimeHours" readonly>
                      <div class="input-group-prepend input-group-colon" style="background:#e9ecef;">
                        <span class="input-group-text">:</span>
                      </div>
                      <input type="number" name="plan_joban_time[1]" class="form-control input-form-left text-center"
                        value="<?php print($plan_joban_time[1]); ?>" min="0" max="59" id="planJobanTimeMinute" readonly>
                    </div>
                  </div>
                </td>
              </tr>
                  ...
                  <div class="input-form-size">
                    <div class="input-group input-group-sm">
                      <input type="number" name="plan_kaban_time[0]" class="form-control input-form-right text-center"
                        value="<?php print($plan_kaban_time[0]); ?>" min="0" max="23" id="planKabanTimeHours" readonly>
                      <div class="input-group-prepend input-group-colon" style="background:#e9ecef;">
                        <span class="input-group-text">:</span>
                      </div>
                      <input type="number" name="plan_kaban_time[1]" class="form-control input-form-left text-center"
                        value="<?php print($plan_kaban_time[1]); ?>" min="0" max="59" id="planKabanTimeMinute" readonly>
                    </div>
                  </div>
                </td>
              </tr>
