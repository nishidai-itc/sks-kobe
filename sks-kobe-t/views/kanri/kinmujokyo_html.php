      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <table class="text-nowrap" border="1" style="font-size: 15pt;" bgcolor="#d5d5d5" width=100%>
            <tr>
              <td bgcolor="FFDCA5" width=100>氏名</td>
            ...
            <tr>
              ...
              <td bgcolor="#d5d5d5" <?php echo $_SESSION["menu_flg"] == "kanri" ? "colspan=2" : "" ; ?>>
                <select id="nengetu" class="form-control" name="nengetu" style="font-size:20px;">
                  ...
                  <option value="<?php echo substr($i,0,6) ?>" <?php echo substr($i,0,6) == $nengetu ? 'selected':"" ?>><?php echo substr($i,0,4)."年".substr($i,4,2)."月" ?></option>
                  <?php } ?>
                </select>
              </td>
          ...
          <?php } ?>
              ...
              <td <?php echo $common->device != "mobile" ? "width=60" : "width=30%"; ?>>
                <button type="submit" class="btn btn-info<?php if ($common->device == "mobile") {print(" w-100");} ?>" role="button" name="search">検索</button>
              </td>
              <td <?php echo $common->device == "mobile" && $_SESSION['menu_flg'] == "kanri" ? "colspan=2" : "width=130"; ?>>
...
?>
            ...
            <?php } ?>
              ...
              <?php } ?>
                ...
                <td>
                <?php
                if ($holday != "" && strpos($holday,$wkdetail->oup_t_wk_plan_date[$i]) !== false) {
                ...
                <!-- 実績 -->
                <td>
                <?php if ($wkdetail->oup_t_wk_plan_joban_time[$i] < $wkdetail->oup_t_wk_joban_time[$i] || ($wkdetail->oup_t_wk_plan_kbn[$i] == 3 && $wkdetail->oup_t_wk_plan_joban_time[$i] > $wkdetail->oup_t_wk_plan_kaban_time[$i] && $wkdetail->oup_t_wk_joban_time[$i] < $wkdetail->oup_t_wk_plan_kaban_time[$i])) {
                    print("<font color=\"red\">");
                } else {
                ...
                <!-- 勤務時間 -->
                <td <?php if ($wkdetail->oup_t_wk_inp_kbn[$i]==1 && $flg != 1) {print("bgcolor=#f7f5bc");} ?>>
                <?php /*
...
//                        $kj=$kj+$wk00_r;
    ...
    //                        $sizan = $sizan + substr($wkdetail->oup_t_wk_midnight_over_time[$i],0,2)*60+substr($wkdetail->oup_t_wk_midnight_over_time[$i],3,2);
                ...
                <?php if ($flg != 1 || ($flg == 1 && $renzan_flg != "false")) { ?>
                    <!-- 連勤残 -->
                    <td <?php if ($wkdetail->oup_t_wk_renzan_kbn[$i]==1 && $flg != 1) {print("bgcolor=#f7f5bc");} ?>>
                    <?php 
...
<?php 
                ...
                if ($wkdetail->oup_t_wk_joban_kbn[$i]=="4" && $wkdetail->oup_t_wk_plan_date[$i] <= date("Y-m-d")) {
                    ...
                    if ($wkdetail->oup_t_wk_joban_time[$i] !== null && $wkdetail->oup_t_wk_kaban_time[$i] !== null) {
                        ...
                        if ($wkdetail->oup_t_wk_daytime_over_time[$i]!="00:00") {
                            $hzan = $hzan + (int)substr($wkdetail->oup_t_wk_daytime_over_time[$i],0,2)*60+(int)substr($wkdetail->oup_t_wk_daytime_over_time[$i],3,2);
                        }
                        if ($wkdetail->oup_t_wk_rest_over_time[$i]!="00:00") {
                            $kzan = $kzan + (int)substr($wkdetail->oup_t_wk_rest_over_time[$i],0,2)*60+(int)substr($wkdetail->oup_t_wk_rest_over_time[$i],3,2);
                        }
                        if ($wkdetail->oup_t_wk_midnight_over_time[$i]!="00:00") {
                            $sizan = $sizan + (int)substr($wkdetail->oup_t_wk_midnight_over_time[$i],0,2)*60+(int)substr($wkdetail->oup_t_wk_midnight_over_time[$i],3,2);
                        }
                    }
                }
?>
      ...
      <div class="row">
        <div class="col-12">
          <table>
              ...
              <td valign="top">
                ...
                <table style="border-collapse:collapse; font-size: 10pt;" cellpadding="4">
                  <tr>
                    ...
                    <td style="border:1px solid black" align="right" width="80" colspan="3"><?php echo $wkdetail->oup_t_wk_detail_no ? count($wkdetail->oup_t_wk_detail_no) : 0 ; ?> <?php if ($staff_id!="" || $flg==1) { print("回"); } else { print("人"); } ?></td>
                  </tr>
                  <tr>
            ...
            <?php if ($flg == 1 && $common->device == "mobile") { ?>
            </tr>
            <tr>
              <td height="30">　
              </td>
                ...
                if ($i == 0) {
                    ...
                    for ($j=0;$j<8;$j++) {
                        if ($j != 5 && $j != 4) {
                            ...
                            if ($kyuyo->oup_m_kyuyo_no[0] != "") { ?>
                                <td colspan=2 class="p-1">
                                  <select class="form-control form-control" name="kyuyo_kbn">
                                    <option value=""></option>
                            ...
                            if ($kyuyo->oup_m_kyuyo_no[0] != "") { ?>
                                <td colspan=2><button type='submit' name='kyuyo' class='btn btn-success btn-block'>登録</button></td>
                            <?php
                            }
                        }
                    }
