...
function confirm1(no,taiin_id,name) {
  ...
  "&shift_no=" + shift_no + "&chk_kbn=" + chk_kbn + "&pos=" + pos;
}
          ...
          <table border="1" class="sheet m-auto" style="border-collapse: collapse; table-layout: fixed;">
            <thead>
              ...
              <?php } ?>
                ...
                <?php $w = date("w", $time); ?>
                <?php if ($i <= intval($lastday)) { ?>
                <th <?php print $dispctl != "" ? 'style="font-size:0.8em;"' : "" ; ?>>
                <?php
                //祝日は赤色に
                if ($holday != "" && strpos($holday,sprintf("%02d",$i)) !== false) {
                  print("<font color=\"red\">");
                } else {
                  if ($week[$w]=="土") {
                ...
                */
                ?>
                <?php print($week[$w]); ?>
                <?php if (($week[$w]=="土") || ($week[$w]=="日") || ($holday != "" && strpos($holday,sprintf("%02d",$i)) !== false)) { print("</font>"); } ?>
                </th>
                <?php } else { ?>
            ...
            <tbody>
              ...
              <?php //for ($i=0;$i<count($wk->oup_t_wk_no);$i++) { ?>
                ...
                <?php if ($dispctl == "") { ?>
                      ...
                      <tr class="text-center" bgcolor="FFDCA5">
                        ...
                        <?php
                        //祝日は赤色に
                        if ($holday != "" && strpos($holday,sprintf("%02d",$j)) !== false) {
                          print("<font color=\"red\">");
                        } else {
                          if ($week[$w]=="土") {
                            print("<font color=\"blue\">");
                        ...
                        ?>
                        <?php print($week[$w]); ?>
                        <?php if (($week[$w]=="土") || ($week[$w]=="日") || ($holday != "" && strpos($holday,sprintf("%02d",$j)) !== false)) {
                          print("</font>");
                        } ?></th>
                        <?php } else { ?>
                        <th <?php print $dispctl != "" ? 'style="font-size:0.8em;"' : "" ; ?>>&nbsp;</th>
              ...
              <tr class="text-center">
                ...
                <td <?php print ($align_center); ?> style="background-color:<?php echo $color[$wk->oup_t_wk_taiin_id[$i]][substr($nengetu, 0, 4)."-".substr($nengetu, 4, 2)."-".$day]; ?>">
                  <?php } ?>
