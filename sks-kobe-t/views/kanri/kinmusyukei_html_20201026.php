...
$(function(){
    ...
    ////nengetu2 = $('#nengetu2').remove();
    //nengetu = $('#nengetu').remove();
    //    //ボタン押下、再読み込み時
    //    if ($('#chk_kbn').prop('checked')) {
    //        //nengetu = $('#nengetu').remove();
    //        //$('#nen').append(nengetu2);
    //        $('#nengetu2').attr('type','text');
    //    } else {
    //        $('#nen').append(nengetu);
    //        //nengetu2 = $('#nengetu2').remove();
    //    }
    ////});
    //$('#chk_kbn').change(function(){
    //    if ($('#chk_kbn').prop('checked')) {
    //        nengetu = $('#nengetu').remove();
    //        //$('#nen').append(nengetu2);
    //        $('#nengetu2').attr('type','text');
    //    } else {
    //        $('#nengetu2').attr('type','hidden');
    //        //nengetu2 = $('#nengetu2').remove();
    //        $('#nen').append(nengetu);
    //    }
    //});
          ...
          <div class="col-xs-12 col-md-12">
            <table border="1">
              <tr align="center">
                ...
                <!-- チェックボックス -->
                <!--<input type="checkbox" id="chk_kbn" name="chk_kbn" value="1" <?php if ($chk_kbn == 1) {print("checked"); } ?>>-->
                </td>
                <?php } ?>
                
                <td id="nen" width="150" bgcolor="d5d5d5">
                
                    <!--<input type="text" list="nengetu" class="form-control" name="nengetu" maxlength="6" placeholder="<?php print($nengetu); ?>">
                    <datalist id="nengetu">-->
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthtomaricnt=$monthtomaricnt+$daytomaricnt[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthyorucnt=$monthyorucnt+$dayyorucntcnt[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthnikincnt=$monthnikincnt+$daynikincnt[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthjikyucnt=$monthjikyucnt+$dayjikyucnt[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthnenkyucnt=$monthnenkyucnt+$daynenkyucnt[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthtomaricnt2=$monthtomaricnt2+$daytomaricnt2[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthyorucnt2=$monthyorucnt2+$dayyorucntcnt2[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthnikincnt2=$monthnikincnt2+$daynikincnt2[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthjikyucnt2=$monthjikyucnt2+$dayjikyucnt2[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthnenkyucnt2=$monthnenkyucnt2+$daynenkyucnt2[$j];
                                    //総合計
...
?>
                                ...
                                if ($j != 0) {
                                    $color = "";
                                    $monthkekkincnt2=$monthkekkincnt2+$daykekkincnt2[$j];
                                    //総合計
