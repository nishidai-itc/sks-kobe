          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
                  ...
                  <select id="kinmu" name="kinmu" class="form-control form-control-sm">
                    ...
                    <option
                      value="<?php print($genba->oup_m_genba_id[0] . ' ' . $shift->oup_m_shift_plan_kbn[$i] . ' ' . $shift->oup_m_shift_plan_hosoku[$i]); ?>" <?php
                        if ($wkdetail->oup_t_wk_genba_id[0] === $shift->oup_m_shift_genba_id[$i] && $wkdetail->oup_t_wk_plan_kbn[0] === $shift->oup_m_shift_plan_kbn[$i] && $wkdetail->oup_t_wk_plan_kaban_time[0] === $shift->oup_m_shift_kaban_time[$i] && $wkdetail->oup_t_wk_plan_hosoku[0] === $shift->oup_m_shift_plan_hosoku[$i]) {
                      echo 'selected';
                  } ?>>
                      <?php
              ...
              <tr>
                ...
                <td class="table-warning text-center">上番
                  <!-- 　<input type="checkbox" name="joban_kbn" value="1" <?php if ($wkdetail->oup_t_wk_joban_kbn[0]=="1") { print("checked"); } ?> >済 -->
              ...
              <tr>
                <td class="table-warning text-center">下番
                      　<input type="checkbox" name="kaban_kbn" value="1" <?php if ($wkdetail->oup_t_wk_kaban_kbn[0]=="1") { print("checked"); } ?> >済
                </td>
                <td>
                  <?php
...
-->
      ...
      <div class="row">
        ...
        <?php
          ...
          <?php } else { ?>
          <a href="haitihyo.php" class="btn btn-secondary btn-block" role="button" aria-pressed="true">戻る</a>
          <?php } ?>
        </div>
      </div>
    </form>
