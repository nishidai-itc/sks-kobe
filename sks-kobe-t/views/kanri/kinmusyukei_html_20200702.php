          ...
          <div class="col-xs-12 col-md-12">
            <table border="1">
              <tr align="center">
                ...
                <td width="60" bgcolor="d5d5d5"><input type="text" name="nengetu" id="nengetu" value="<?php print($nengetu); ?>"></td>
              </tr>
            </table>
          </div>
        </div>
...
<?php 
                ...
                $syukeichk = $tomaricnt*2+$yorucnt+$nikincnt;
?>
                        ...
                        <td>&nbsp;</td>
                        <td align="center"><?php print($tomaricnt*2+$yorucnt+$nikincnt); ?></td>
                    </tr>
...
<?php 
                ...
                if ($syukeichk != $tomaricnt*2+$yorucnt+$nikincnt) {
                    $ng = 1;
                }
?>
                        <td align="center"><?php print($tomaricnt); ?></td>
                        ...
                        <td align="center"><?php print($nikincnt); ?></td>
                        <td>&nbsp;</td>
                        <td align="center"><?php if ($ng==1) { print("<font color='red'>"); } ?><?php print($tomaricnt*2+$yorucnt+$nikincnt); ?></td><?php if ($ng==1) { print("</font>"); } ?>
                    </tr>
