...
$pdf->Text(88, 34, $staffs[$report->oup_patrol_staff_id1[0]]);     // 巡回者氏名
$pdf->Text(108, 34, $staffs[$report->oup_patrol_staff_id2[0]]);    // 巡回者氏名1
$pdf->Text(128, 34, $staffs[$report->oup_patrol_staff_id3[0]]);     // 巡回者氏名1
$pdf->Text(148, 34, $staffs[$report->oup_patrol_staff_id4[0]]);    // 警備員2
$pdf->Text(168, 34, $staffs[$report->oup_patrol_staff_id5[0]]);     // 警備員2
...
$pdf->Text(88, 39, $report->oup_patrol_time1[0]);     // 巡回1
$pdf->Text(108, 39, $report->oup_patrol_time2[0]);     // 巡回2
$pdf->Text(128, 39, $report->oup_patrol_time3[0]);     // 巡回3
$pdf->Text(148, 39, $report->oup_patrol_time4[0]);     // 巡回4
$pdf->Text(168, 39, $report->oup_patrol_time5[0]);     // 巡回1
$pdf->Text(187, 39, $report->oup_patrol_time6[0]);     // 巡回2
$pdf->Text(205, 39, $report->oup_patrol_time7[0]);     // 巡回3
$pdf->Text(223, 39, $report->oup_patrol_time8[0]);     // 巡回4
$pdf->Text(242, 39, $report->oup_patrol_time9[0]);     // 巡回4
$pdf->Text(260, 39, $report->oup_patrol_time10[0]);     // 巡回4
