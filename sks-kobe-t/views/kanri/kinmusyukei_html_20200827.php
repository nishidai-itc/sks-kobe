...
<?php 
    if ($act == "0") {
?>
              <table class="text-nowrap" style="border: solid 1px #000000; border-collapse:collapse; font-size: 10pt; width:1100px">
<?php 
...
?>
                        ...
                        <td style="border: solid 1px;" align="center"><?php print($tomaricnt); ?></td>
                        <td style="border: solid 1px;" align="center"><?php print($yorucnt); ?></td>
                        <td style="border: solid 1px;" align="center"><?php print($nikincnt); ?></td>
                        <td style="border: solid 1px;" align="center"><?php print($jikyucnt); ?></td>
                        <td style="border: solid 1px;">&nbsp;</td>
                        <td style="border: solid 1px;">&nbsp;</td>
                        <td style="border: solid 1px;">&nbsp;</td>
                        <td style="border: solid 1px;" align="center"><?php print($tomaricnt*2+$yorucnt+$nikincnt+$jikyucnt); ?></td>
                    </tr>
...
?>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($tomaricnt); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($yorucnt); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($nikincnt); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($jikyucnt); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($nenkyucnt); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($kekkincnt); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($jikyu_total); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php if ($ng==1) { print("<font color='red'>"); } ?><?php print($tomaricnt*2+$yorucnt+$nikincnt+$jikyucnt); ?></td><?php if ($ng==1) { print("</font>"); } ?>
                    </tr>
...
?>
                        ...
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC">&nbsp;</td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC">&nbsp;</td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC"><?php print($wk5); ?></td>
                        <td style="border: solid 1px;" align="center" bgcolor="#CCFFCC">&nbsp;</td>
                    </tr>
...
?>
                            <td style="border: solid 1px;" align="center"><?php print($monthtomaricnt); ?></td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthyorucnt); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthnikincnt); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthjikyucnt); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center"><?php print($monthtomaricnt2); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthyorucnt2); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthnikincnt2); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthjikyucnt2); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthnenkyucnt2); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
...
?>
                            ...
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center"><?php print($monthkekkincnt2); ?></td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
                            <td style="border: solid 1px;" align="center">&nbsp;</td>
