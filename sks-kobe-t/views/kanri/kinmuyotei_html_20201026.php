        ...
        <div class="col-xs-12 col-md-12">
          <table style="border-collapse:collapse;">
            <tr>
              ...
              <td style="border:1px; border-style: solid;" bgcolor="#d5d5d5">
                <table>
                  <tr>
...
?>
              ...
              <td ><input type="button" class="btn btn-warning btn-block" role="button" name="print" value="印刷用照会" onClick="FJS_Location(1,<?php print($nengetu); ?>)"></td>
              <td width="50">&nbsp;</td>
              
              <?php //if ($genba_flg != true) { ?>
              <td ><button type="submit" class="btn btn-success btn-block" role="button" name="copy">前月コピー</button></td>
              <?php //} ?>
...
<?php */ ?>
      ...
      <?php //if ($genba_flg != true) { ?>
        ...
        <?php } else { ?>
          <a href="kinmuyotei.php?search=&conf=&genba_id=<?php print($genba_id); ?>&nengetu=<?php print($nengetu); ?>" class="btn btn-<?php if ($wkdetail_conf_flg == 1 || $genba_id == "") {print("dark disabled1");} else {print("success");} ?> btn-block"
