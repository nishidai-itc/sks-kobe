          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="table-warning text-center">上番
                   <label>　<input type="checkbox" id="joban_kbn" name="joban_kbn" value="1" <?php if ($wkdetail->oup_t_wk_joban_kbn[0]=="1") { print("checked"); } ?> > 済</label>
                ...
                <td>
                  ...
                  ?>
                  <div class="input-form-size" style="float:left;">
                    <div class="input-group input-group-sm">
                  ...
                  <span style="padding:0 30px 0 100px;">
              ...
              <tr>
                <td class="table-warning text-center">下番
                    <label>　<input type="checkbox" id="kaban_kbn" name="kaban_kbn" value="1" <?php if ($wkdetail->oup_t_wk_kaban_kbn[0]=="1") { print("checked"); } ?> > 済</label>
                </td>
                <td>
                  <?php
