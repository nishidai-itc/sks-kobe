              ...
              <tr>
                ...
                <td nowrap style="padding:2px;">
                    <?php for ($j=0; $j<count($work_mem2->oup_t_wk_taiin_id); $j++) { ?>
                      ...
                      <b><span class="font margin_b span" style="background-color:<?php print($color); ?>;">
                          ...
                          <?php print("&nbsp;".str_replace(array(" ","　"),"",$staffs[$work_mem2->oup_t_wk_taiin_id[$j]])); ?><?php print("(".date('n', strtotime($work_mem2->oup_t_wk_plan_date[$j]))."/".date('j', strtotime($work_mem2->oup_t_wk_plan_date[$j])).")"); ?>
                          </a>
                        </span></b><br>
                      <?php } ?>
                    <?php } ?>
                    <?php for ($j=0;$j<count($wkdetail->oup_t_wk_detail_no);$j++) { ?>
                      ...
                      <font color="gray">
                      <?php } ?>
                        <?php print("&nbsp;".str_replace(array(" ","　"),"",$staffs[$wkdetail->oup_t_wk_taiin_id[$j]])); ?></a></span></b></font>
                        <?php /* if ($wkdetail->oup_t_wk_joban_kbn[$j]!="") { ?>
                ...
                <td nowrap style="">
                    ...
                    <?php for ($j=0;$j<count($wkdetail2->oup_t_wk_detail_no);$j++) { ?>
                      ...
                      <font color="gray">
                      <?php } ?>
                        <?php print("&nbsp;".str_replace(array(" ","　"),"",$staffs[$wkdetail2->oup_t_wk_taiin_id[$j]])); ?></a></span></b></font>
                        <?php /* if ($wkdetail->oup_t_wk_joban_kbn[$j]!="") { ?>
                            <?php print(" ".$wkdetail->oup_t_wk_joban_time[$j]."」"); ?>
                        <?php } */ ?>
                    <!--     /　-->
                ...
                <td nowrap>
                    <?php for ($j=0; $j<count($work_mem4->oup_t_wk_taiin_id); $j++) { ?>
                      ...
                      <b><span class="font margin_b span" style="background-color:<?php print($color); ?>;">
                          ...
                          <?php print("&nbsp;".str_replace(array(" ","　"),"",$staffs[$work_mem4->oup_t_wk_taiin_id[$j]])); ?><?php print("(".date('n', strtotime($work_mem4->oup_t_wk_plan_date[$j]))."/".date('j', strtotime($work_mem4->oup_t_wk_plan_date[$j])).")"); ?>
                          </a>
                        </span></b><br>
                      <?php } ?>
                    <?php } ?>
                    <?php for ($j=0;$j<count($wkdetail3->oup_t_wk_detail_no);$j++) { ?>
                      ...
                      <font color="gray">
                      <?php } ?>
                        <?php print("&nbsp;".str_replace(array(" ","　"),"",$staffs[$wkdetail3->oup_t_wk_taiin_id[$j]])); ?></a></span></b></font>
                        <?php /* if ($wkdetail->oup_t_wk_joban_kbn[$j]!="") { ?>
                            <?php print(" ".$wkdetail->oup_t_wk_joban_time[$j]."」"); ?>
                        <?php } */ ?>
                    <!--     /　--><br />
