              ...
              <td style="border:1px; border-style: solid;">
                <table>
                  <tr>
                    <td>
                      <!-- シフト -->
                      <select id="shift_no" name="shift_no" class="form-control" <?php print($disabled); ?>>
                        <option></option>
...
?>
              ...
              <td ><input type="button" class="btn btn-secondary btn-block" role="button" name="print" value="印刷用照会" onClick="FJS_Location(1)"></td>
              <td width="50">&nbsp;</td>
