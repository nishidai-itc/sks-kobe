...
<script type="text/javascript">
  ...
  var daysList = {
    // 上番、下番時刻（平日）
    'weekday':{'j1':['08','30'],'j2':['08','30'],'j3':['08','30'],'k1':['16','30'],'k2':['16','30'],'k3':['16','30']},
    // 上番、下番時刻（土曜）
  ...
  var patrolList = {
    // 巡回時刻（平日）
    'weekday2':{
      '1':['17','30'],'2':['19','00'],'3':['21','00'],'4':['22','30'],'5':['00','00'],'6':['01','00'],
    ...
    'saturday2':{
      ...
      '7':['00','00'],'8':['01','00'],'9':['02','00'],'10':['03','00'],'11':['04','00'],'12':['05','30'],
      '13':['06','30'],'14':['',''],'15':['',''],'16':['','']
    },
    // 巡回時刻（日曜、祝日）
    'holiday2':{
      '1':['08','00'],'2':['10','00'],'3':['12','00'],'4':['14','00'],'5':['16','00'],'6':['17','30'],
      '7':['19','00'],'8':['21','00'],'9':['22','30'],'10':['00','00'],'11':['01','00'],'12':['02','30'],
