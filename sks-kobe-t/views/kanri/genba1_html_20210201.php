...
<html lang="ja">
  ...
  <body>
    <div class="container">
      ...
      <form name="frm" method="POST" action="genba1.php">
...
<?php for ($i=0;$i<count($genba->oup_m_genba_id);$i++) { 
              ...
              <tr align="center">
                ...
                <?php if ($i == 0) { ?>
                <td width="85" bgcolor="FFDCA5"><label for="genba">現場ID</label><button type="submit" name="genba_sort" id="genba" class="btn badge" style="background:#FFDCA5;" value="<?php echo $genba_sort == '1' ? '0' : '1' ; ?>"><?php echo $genba_sort == "1" ? "<font color=\"red\">▼</font>" : "▼" ; ?></button></td>
                <?php } else { ?>
                ...
                <?php if ($i == 0) { ?>
                <td width="100" bgcolor="FFDCA5"><label for="hyoji">表示順序</label><button type="submit" name="hyoji_sort" id="hyoji" class="btn badge" style="background:#FFDCA5;" value="<?php echo $hyoji_sort == '1' ? '0' : '1' ; ?>"><?php echo $hyoji_sort == "1" ? "<font color=\"red\">▼</font>" : "▼" ; ?></button></td>
                <?php } else { ?>
                ...
                <?php } ?>
              <tr align="center" <?php echo $genba->oup_m_genba_deleteday[$i] != "" ? "bgcolor='#d5d5d5'" : "" ; ?>>
                <td>
                ...
                <td><?php print($genba->oup_m_genba_deleteday[$i]); ?></td>
