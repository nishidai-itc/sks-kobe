...
<!--      <div class="page-header">
      ...
      <form name="frm" method="POST" action="login.php">
          <table class="page-header w-75" style="margin-bottom:20px;">
            <tr nowrap class="w-100">
              ...
              &nbsp;&nbsp;&nbsp;<?php print(substr(date("H:i"),0,2)); ?>時<?php print(substr(date("H:i"),2,3)); ?>分&nbsp;現在</td>
...
<!--            <table border="1">
            ...
            <table class="text-center" border="1">
                <tr>
                    <td width="100" bgcolor="93FFAB">本部</td>
                    <td width="100" bgcolor="FFFF99">常用</td>
                    <td width="100" bgcolor="FFAD90">登録</td>
                    <td width="100" bgcolor="A4C6FF">協力会社</td>
                </tr>
            </table>
          </div>
        </div>
...
<?php for($i=0;$i<count($genba->oup_m_genba_id);$i++){ ?>
              ...
              */?>
              ...
              $wkdetail   = new Wkdetail;     
                    // 予定の検索条件セット
                    $wkdetail->inp_t_wk_plan_date2 = $targetday;
              ...
              // 予定の検索条件セット
              $wkdetail2->inp_t_wk_plan_date2 = $targetday;
              ...
              // 予定の検索条件セット
              $wkdetail3->inp_t_wk_plan_date2 = $targetday;
              ...
              <tr>
                ...
                <td nowrap><?php print($genba->oup_m_genba_name[$i]); ?></td>
                ...
                <td>
                    <?php for ($j=0; $j<count($work_mem2->oup_t_wk_taiin_id); $j++) { ?>
                      ...
                      <span style="background-color:<?php print($color); ?>;">
                          <a style="color:black; text-decoration: none;" href="kinmujokyosyousai.php?no=<?php print($work_mem2->oup_t_wk_detail_no[$j]); ?>">
                          <?php print($staffs[$work_mem2->oup_t_wk_taiin_id[$j]]); ?>&nbsp;<?php print("(".date('n', strtotime($work_mem2->oup_t_wk_plan_date[$j]))."/".date('j', strtotime($work_mem2->oup_t_wk_plan_date[$j])).")"); ?>
                          </a>
                        </span><br>
                      <?php } ?>
                    <?php } ?>
                    <?php for ($j=0;$j<count($wkdetail->oup_t_wk_detail_no);$j++) { ?>
                      ...
                      <font color="gray">
                      <?php } ?>
                        <?php print($staffs[$wkdetail->oup_t_wk_taiin_id[$j]]); ?></a></span></font>
                        <?php /* if ($wkdetail->oup_t_wk_joban_kbn[$j]!="") { ?>
                ...
                <td style="width:33.3%;">
                    <?php for ($j=0; $j<count($work_mem3->oup_t_wk_taiin_id); $j++) { ?>
                      ...
                      <?php if ($work_mem3->oup_t_wk_joban_kbn[$j] != "" && $work_mem3->oup_t_wk_kaban_kbn[$j] != "1") { ?>
                        <span style="font-size:14px; text-align: center; margin-bottom:2px; background-color:<?php print($color); ?>; display: inline-block; max-width: 118px; min-width: 118px;">
                          ...
                          <?php print(str_replace(array(" ","　"),"",$staffs[$work_mem3->oup_t_wk_taiin_id[$j]])); ?><?php print("(".date('n', strtotime($work_mem3->oup_t_wk_plan_date[$j]))."/".date('j', strtotime($work_mem3->oup_t_wk_plan_date[$j])).")"); ?>
                          </a>
                        </span>
                      <?php } ?>
                      <?php if (($j != 0 && $j == 2) || ($j == 2 + (3 * $count3))) {
                          print("<br>");
                          $count3 = 1 + $count3;
                        } ?>
                    <?php } ?>
                    <?php if(count($work_mem3->oup_t_wk_taiin_id) != 0 && count($work_mem3->oup_t_wk_taiin_id) %3 != 0) {
                        print("<br>");
                    } ?>
                    <?php for ($j=0;$j<count($wkdetail2->oup_t_wk_detail_no);$j++) { ?>
                      ...
                      <span style="text-align: center; margin-bottom:2px; background-color:<?php print($color); ?>; display: inline-block; max-width: 118px; min-width: 118px;">
                      ...
                      <font color="gray">
                      <?php } ?>
                        <?php print(str_replace(array(" ","　"),"",$staffs[$wkdetail2->oup_t_wk_taiin_id[$j]])); ?></a></span></font>
                        <?php /* if ($wkdetail->oup_t_wk_joban_kbn[$j]!="") { ?>
                            <?php print(" ".$wkdetail->oup_t_wk_joban_time[$j]."」"); ?>
                        <?php } */ ?>
                    <!--     /　-->
                        <?php if (($j != 0 && $j == 2) || ($j == 2 + (3 * $count2))) {
                              print("<br>");
                              $count2 = 1 + $count2;
                            } ?>
                    <?php } ?>
                ...
                <td>
                    <?php for ($j=0; $j<count($work_mem4->oup_t_wk_taiin_id); $j++) { ?>
                      ...
                      <span style="background-color:<?php print($color); ?>;">
                          ...
                          <?php print($staffs[$work_mem4->oup_t_wk_taiin_id[$j]]); ?>&nbsp;<?php print("(".date('n', strtotime($work_mem4->oup_t_wk_plan_date[$j]))."/".date('j', strtotime($work_mem4->oup_t_wk_plan_date[$j])).")"); ?>
                          </a>
                        </span><br>
                      <?php } ?>
                    <?php } ?>
                    <?php for ($j=0;$j<count($wkdetail3->oup_t_wk_detail_no);$j++) { ?>
                      ...
                      <font color="gray">
                      <?php } ?>
                        <?php print($staffs[$wkdetail3->oup_t_wk_taiin_id[$j]]); ?></a></span></font>
                        <?php /* if ($wkdetail->oup_t_wk_joban_kbn[$j]!="") { ?>
                            <?php print(" ".$wkdetail->oup_t_wk_joban_time[$j]."」"); ?>
                        <?php } */ ?>
                    <!--     /　--><br />
