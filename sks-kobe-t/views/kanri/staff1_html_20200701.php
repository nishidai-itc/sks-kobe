...
<?php for ($i=0;$i<count($staff->oup_m_staff_id);$i++) { 
              ...
              <tr align="center">
                ...
                <td width="150" bgcolor="FFDCA5">退社日</td>
              ...
              <tr align="center">
                ...
                <td>
                <?php if ($staff->oup_m_staff_nyusya[$i] != "0000-00-00") { ?>
                    <?php print($staff->oup_m_staff_nyusya[$i]); ?>
                <?php } ?>
                </td>
                <td>
                <?php if ($staff->oup_m_staff_taisya[$i] != "0000-00-00") { ?>
                    <?php print($staff->oup_m_staff_taisya[$i]); ?>
                <?php } ?>
                </td>
                <td><?php print($staff->oup_m_staff_company[$i]); ?></td>
                <td><a href="#" onClick="confirm1('<?php print($staff->oup_m_staff_id[$i]); ?>');">削</a></td>
              </tr>
<?php } ?>
            </table>
          </div>
