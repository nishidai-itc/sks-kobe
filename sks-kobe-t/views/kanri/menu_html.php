...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card" style="padding: 10px;">
          <div class="card-body">
          <?php print("<table><tr><td nowrap>".$common->html_display($staff->oup_m_staff_name[0])); ?> さん
          <?php
          if ($tuti->oup_m_tuti_msg) {
          if (count($tuti->oup_m_tuti_msg) == 1) {
            ...
            print("</td></tr><tr><td>".date('m/d')."(".$week[$w].")".date('H:i')."</td></tr></table>");
          }
          ?>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-4 my-1">
        <button class="btn btn-success  btn-block" role="button" style="height: 70px;"
          onclick="location.href='./kinmujokyo.php?flg=1'">勤務照会</button>
      </div>
      ...
      <div class="col-4 my-1">
        <button class="btn btn-success btn-block" role="button" style="height: 70px;"
          onclick="location.href='kinmusyukei.php?flg=3'">勤務実績表</button>
      </div>
      ...
      <div class="col-4 my-1">
        <button class="btn btn-success btn-block" role="button" style="height: 70px;"
          onclick="location.href='kinmusyukei.php'">給与連携処理（総務）</button>
      </div>
      <!-- <div class="col-4 my-1">
      ...
      <div class="col-4 my-1">
        <button class="btn btn-success btn-block" role="button" style="height: 70px;"
          onclick="location.href='kinmujokyo.php?flg=2'">勤務状況一覧 （総務）</button>
      </div>
      ...
      <div class="col-4 my-1">
        <button class="btn btn-success btn-block" role="button" style="height: 70px;"
          onclick="location.href='keibihokoku.php'">警備報告一覧</button>
      </div>
