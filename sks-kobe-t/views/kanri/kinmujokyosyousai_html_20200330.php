  ...
  <div class="container">
        ...
        <table class="table table-sm table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <?php print(substr($wkdetail->oup_t_wk_plan_date[0], 0, 4)."年".substr($wkdetail->oup_t_wk_plan_date[0], 5, 2)."月".substr($wkdetail->oup_t_wk_plan_date[0], 8, 2)."日"); ?>(<?php print($week[$w]); ?>)
              </td>
            ...
            <tr>
              ...
              <td>
                <div id="genbaName"><?php echo $genba_name; ?></div>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <form name="frm" method="POST" action="kinmujokyosyousai.php">
          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <select id="kinmu" name="kinmu" class="form-control form-control-sm">
                    ...
                    <option
                      value="<?php print($genba->oup_m_genba_id[0] . ' ' . $shift->oup_m_shift_plan_kbn[$i] . ' ' . $shift->oup_m_shift_plan_hosoku[$i]); ?>" <?php
                  if ($wkdetail->oup_t_wk_plan_kbn[0] === $shift->oup_m_shift_plan_kbn[$i] && $wkdetail->oup_t_wk_plan_hosoku[0] === $shift->oup_m_shift_plan_hosoku[$i]) {
                      echo 'selected';
                  } ?>>
                      <?php
              ...
              <tr>
                ...
                <td class="table-warning text-center">上番</td>
                <td>
                  <?php
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="input-form-size">
                    <div class="input-group input-group-sm">
                      <input type="number" name="joban_time[0]" class="form-control input-form-right text-center"
                        value="<?php print($joban_time[0]); ?>" min="0" max="23">
                      <div class="input-group-prepend input-group-colon">
                        <span class="input-group-text">:</span>
                      </div>
                      <input type="number" name="joban_time[1]" class="form-control input-form-left text-center"
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="input-form-size">
                    <div class="input-group input-group-sm">
                      <input type="number" name="kaban_time[0]" class="form-control input-form-right text-center"
                        value="<?php print($kaban_time[0]); ?>" min="0" max="23">
                      <div class="input-group-prepend input-group-colon">
                        <span class="input-group-text">:</span>
                      </div>
                      <input type="number" name="kaban_time[1]" class="form-control input-form-left text-center"
              ...
              <tr>
                ...
                <td><input type="time" name="daytime_over_time" class="form-control form-control-sm"
                    value="<?php echo $wkdetail->oup_t_wk_daytime_over_time[0]; ?>"></td>
              </tr>
              <tr>
                <td class="table-warning text-center">休憩残業</td>
                <td><input type="time" name="rest_over_time" class="form-control form-control-sm"
                    value="<?php echo $wkdetail->oup_t_wk_rest_over_time[0]; ?>"></td>
              </tr>
              <tr>
                <td class="table-warning text-center">深夜残業</td>
                <td><input type="time" name="midnight_over_time" class="form-control form-control-sm"
                    value="<?php echo $wkdetail->oup_t_wk_midnight_over_time[0]; ?>"></td>
              </tr>
              ...
              <tr>
                ...
                <td><input type="tel" name="post_teate" class="form-control form-control-sm"
                    value="<?php echo $wkdetail->oup_t_wk_post_teate[0]; ?>"></td>
              </tr>
              <tr>
      ...
      <div class="row">
        ...
        <div class="col-6">
          <a href="kinmujokyo.php" class="btn btn-secondary btn-block" role="button" aria-pressed="true">戻る</a>
        </div>
      </div>
    </form>
  </div>
