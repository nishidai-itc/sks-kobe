...
<!--                    <td bgcolor="#d5d5d5">
                    ...
                    <td bgcolor="#d5d5d5">
                        <select style="width:70px;" name="chk_search" class="form-control">
                        <option value="" <?php if ($chk_search == "") {print("selected");} ?>></option>
                        <option value="0" <?php if ($chk_search == "0") {print("selected");} ?>>未</option>
                        <option value="1" <?php if ($chk_search == "1") {print("selected");} ?>>G</option>
                        <option value="2" <?php if ($chk_search == "2") {print("selected");} ?>>S</option>
                        </select>
                    </td>
                    <td bgcolor="#d5d5d5">&nbsp;&nbsp;&nbsp;
                    </td>
...
?>
            ...
            <tbody>
              ...
              <tr class="text-center" <?php if ($i == 0 || $i%2 == 0) { print("bgcolor=#e1f6fc"); } ?>>
                ...
                <!-- チェック -->
                <td <?php if ($wkdetail->oup_t_wk_chk_kbn[$i] == "1") {print("bgcolor=#80FF00");} elseif ($wkdetail->oup_t_wk_chk_kbn[$i] == "2") {print("bgcolor=silver");} ?>>
                  <?php if ($wkdetail->oup_t_wk_chk_kbn[$i] == "1") {
                    print("G");
                  } elseif ($wkdetail->oup_t_wk_chk_kbn[$i] == "2") {
                    print("S");
                  } else {
                    print("");
                  } ?>
                ...
                <?php if (($wkdetail->oup_t_wk_plan_kbn[$i] != 1 && $wkdetail->oup_t_wk_plan_kaban_time[$i] > $wkdetail->oup_t_wk_kaban_time[$i] && $wkdetail->oup_t_wk_joban_time[$i] < $wkdetail->oup_t_wk_kaban_time[$i])
                 || ($wkdetail->oup_t_wk_plan_kbn[$i] == 1 && $wkdetail->oup_t_wk_plan_kaban_time[$i] > $wkdetail->oup_t_wk_kaban_time[$i])) {print("<font color=\"red\">");} else {print("<font color=\"black\">");} ?>
...
//                            print($wkdetail->oup_t_wk_stminus[$i]);
                ...
                */?>
                ...
                if ($wkdetail->oup_t_wk_kinmu_time[$i] != 0.00 && $wkdetail->oup_t_wk_kinmu_time[$i] != "") {
                    if ($wkdetail->oup_t_wk_plan_kbn[$i] == 1) {
                        ...
                        if ($wkdetail->oup_t_wk_plan_kbn[$i] == 6) {
                            print("<font color=\"red\">");
                            $kjikyu=$kjikyu+$wkdetail->oup_t_wk_kinmu_time[$i];
                        } elseif ($wk00_r > $wkdetail->oup_t_wk_kinmu_time[$i] || ($wkdetail->oup_t_wk_plan_joban_time[$i] < $wkdetail->oup_t_wk_joban_time[$i] && $wkdetail->oup_t_wk_kaban_time[$i] != "") || ($wkdetail->oup_t_wk_plan_kaban_time[$i] > $wkdetail->oup_t_wk_kaban_time[$i] && $wkdetail->oup_t_wk_joban_time[$i] != "" && $wkdetail->oup_t_wk_joban_time[$i] < $wkdetail->oup_t_wk_kaban_time[$i])) {
                            if ($wkdetail->oup_t_wk_inp_kbn[$i] != 1) {
                                print("<font color=\"red\">");
                                $jikyu = 1;
                            }
                ...
                //var_dump($wkdetail->oup_t_wk_kinmu_time[$i],$wk00_ro,$wkdetail->oup_t_wk_joban_time[$i]);
                ?>
                </td>
                <!-- 所定残 -->
                <td <?php if ($wkdetail->oup_t_wk_inp_kbn[$i]==1) {print("bgcolor=#f7f5bc");} ?>>
...
//                  $wk00_r = ($shift2_rod[$wkdetail->oup_t_wk_genba_id[$i]][$wkdetail->oup_t_wk_plan_kbn[$i]][$wkdetail->oup_t_wk_plan_joban_time[$i]][$wkdetail->oup_t_wk_plan_kaban_time[$i]])*60;
//                  if ($wkdetail->oup_t_wk_plan_kbn[$i] == 1 || $wkdetail->oup_t_wk_plan_kbn[$i] == 2 || $wkdetail->oup_t_wk_plan_kbn[$i] == 3) {
              ...
              <td valign="top">
                ...
                <table style="border-collapse:collapse; font-size: 10pt;" cellpadding="4">
                  ...
                  <tr>
                    ...
                    <td style="border:1px solid black" align="right"><?php print($jcnt); ?> <?php if ($staff_id!="") { print("回"); } else { print("人"); } ?></td>
                  </tr>
                </table>
