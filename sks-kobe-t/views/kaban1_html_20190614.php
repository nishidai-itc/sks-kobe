    ...
    <div class="container">
      ...
      <form name="frm" method="POST" action="login.php">
        ...
        <div class="row">
          ...
          <div class="col-2"></div>
          <div class="col-4 bg-success border border-dark text-center">休憩残業雛形</div>
          ...
          <div class="col-2"></div>
          <div class="col-4 bg-success border border-dark text-center">深夜残業雛形</div>

          <div class="col-8"></div>
          <div class="col-2 border border-dark text-center">
            <input type="time" step="60" name="kaban_time" class="form-control" value="22:00">
          </div>
          <div class="col-2 border border-dark text-center">
            <input type="time" step="60" name="kaban_time" class="form-control" value="08:00">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-12 bg-warning border border-dark text-center">休憩残業</div>
          <div class="col-12 bg-warning border border-dark text-center">深夜残業</div>
          ...
          <div class="col-1 border border-dark text-center"><a href="#">昼残無</a></div>
          <div class="col-1 border border-dark text-center"><a href="#">昼残無</a></div>
          <div class="col-1 border border-dark text-center"><a href="#">昼残無</a></div>
          <div class="col-1 border border-dark text-center"><a href="#">昼残無</a></div>
          <div class="col-1 border border-dark text-center"><a href="#">昼残無</a></div>
          ...
          <div class="col-1 border border-dark text-center"><a href="#">深残無</a></div>
          <div class="col-1 border border-dark text-center"><a href="#">深残無</a></div>
          <div class="col-1 border border-dark text-center"><a href="#">深残無</a></div>
          <div class="col-9 border border-dark text-center"></div>
