  ...
  <body>
    <div class="container">
      ...
      <form name="frm" method="POST" action="login.php">
        ...
        <div class="row">
          <div class="col-6">
            <a href="kaban7.php" class="btn btn-success btn-lg btn-block" role="button" aria-pressed="true">登録する</a>
          </div>
          <div class="col-6">
            <a href="kaban9.php" class="btn btn-info btn-lg btn-block" role="button" aria-pressed="true">登録しない</a>
          </div>
          <div class="col-12">
            &nbsp;
          </div>
          <div class="col-12">
            <a href="kaban4.php" class="btn btn-secondary btn-lg btn-block" role="button" aria-pressed="true">戻る</a>
          </div>
        </div>
        <br />
