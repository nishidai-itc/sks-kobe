      ...
      <table class="table table-sm table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td class="table-info text-center font-weight-bold" colspan="3">上番報告（リーダー用）</td>
          </tr>
          <tr>
            ...
            <?php } else { ?>
                ...
                <td nowrap bgcolor="#d5d5d5">
                    <button type="submit" class="btn btn-success" role="button" name="search">検索</button>
                </td>
            <?php } ?>
          </tr>
        </tbody>
...
//              if ($shift->kbn2[$work_mem->oup_t_wk_plan_kbn[$i]] != "年休") {?>
            ...
            <tr class="text-center">
              ...
              <!-- 勤務 -->
              <td><?php print($shift->kbn2[$work_mem->oup_t_wk_plan_kbn[$i]]); ?></td>
              <!-- 所定時間 -->
              <td>
