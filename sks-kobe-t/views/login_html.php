  ...
  <body>
    <div class="container">
      ...
      <form name="frm" method="POST" action="login.php" autocomplete="off">
        ...
        <div class="row">
          <div class="col-12">
            <input type="tel" name="staff_login_id" value="<?php print($staff_login_id); ?>" class="form-control">
          </div>
        </div>
        <br />
        <div class="row">
        ...
        <div class="row">
          <div class="col-12">
              <input type="tel" name="staff_pass" value="<?php print($staff_pass); ?>" class="form-control">
          </div>
        </div>
        <div class="row">
          <div class="col-12"><label class="checkbox"><input type="checkbox" name="nextpass" value="1" <?php echo isset($_SESSION["nextpass"]) ? "checked" : "" ; ?>> 次回からの入力を省略</label></div>
        </div>
        <div class="row">
          <div class="col-12">
