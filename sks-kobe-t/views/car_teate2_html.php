...
<body>
  <div class="container">
    ...
    <form name="frm" method="POST" action="car_teate2.php" onSubmit="return false;">
      ...
      $staff->inp_m_staff_id = $car_teate->oup_m_car_teate_staff_id[0];
      $staff->getStaff();
        ...
        <div class="col-12">
          <table class="table table-sm table-bordered">
            ...
            <tr class="text-center">
              ...
              <td>
                <select name="shift_no" class="form-control form-control-sm">
                  <option value="">
                    <?php if ($staff_list->oup_m_staff_id) { ?>
              ...
              <td>
                <select name="shift_no" class="form-control form-control-sm">
                  ...
                  <option value="<?php echo $shift->oup_m_shift_no[$i]; ?>" <?php
                    if ($car_teate->oup_m_car_teate_shift_no[0] == $shift->oup_m_shift_no[$i]) {
                        echo ' selected';
                    } ?>>
            ...
            <tr class="text-center">
              ...
              <td><input type="text" name="kuruma_cost" class="form-control form-control-sm" value="<?php print($car_teate->oup_m_car_teate_kuruma_cost[0]); ?>" max="1000000" min="0"></td>
            </tr>
          </table>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-6">
          <a href="car_teate1.php" class="btn btn-secondary btn-block" role="button" aria-pressed="true">戻る</a>
        </div>
      </div>
      <br />

      <input type="hidden" name="act" value="1">
      <input type="hidden" name="car_teate_no" value="<?php print($car_teate->oup_m_car_teate_no[0]); ?>">
